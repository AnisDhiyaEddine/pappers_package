...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.EntrepriseFicheAllOfDepotsActes();
  });
  ...
  describe('EntrepriseFicheAllOfDepotsActes', function() {
    it('should create an instance of EntrepriseFicheAllOfDepotsActes', function() {
      // uncomment below and update the code to test EntrepriseFicheAllOfDepotsActes
      //var instane = new PappersApi.EntrepriseFicheAllOfDepotsActes();
      //expect(instance).to.be.a(PappersApi.EntrepriseFicheAllOfDepotsActes);
    });
    ...
    it('should have the property dateDepot (base name: "date_depot")', function() {
      ...
      //var instance = new PappersApi.EntrepriseFicheAllOfDepotsActes();
    ...
    it('should have the property actes (base name: "actes")', function() {
      // uncomment below and update the code to test the property actes
      //var instance = new PappersApi.EntrepriseFicheAllOfDepotsActes();
      //expect(instance).to.be();
    });
