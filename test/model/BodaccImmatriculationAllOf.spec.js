...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccImmatriculationAllOf();
  });
  ...
  describe('BodaccImmatriculationAllOf', function() {
    it('should create an instance of BodaccImmatriculationAllOf', function() {
      // uncomment below and update the code to test BodaccImmatriculationAllOf
      //var instane = new PappersApi.BodaccImmatriculationAllOf();
      //expect(instance).to.be.a(PappersApi.BodaccImmatriculationAllOf);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccImmatriculationAllOf();
