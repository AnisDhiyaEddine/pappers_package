...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccVenteAllOf();
  });
  ...
  describe('BodaccVenteAllOf', function() {
    it('should create an instance of BodaccVenteAllOf', function() {
      // uncomment below and update the code to test BodaccVenteAllOf
      //var instane = new PappersApi.BodaccVenteAllOf();
      //expect(instance).to.be.a(PappersApi.BodaccVenteAllOf);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccVenteAllOf();
