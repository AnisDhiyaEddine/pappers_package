...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccCreationAllOf();
  });
  ...
  describe('BodaccCreationAllOf', function() {
    it('should create an instance of BodaccCreationAllOf', function() {
      // uncomment below and update the code to test BodaccCreationAllOf
      //var instane = new PappersApi.BodaccCreationAllOf();
      //expect(instance).to.be.a(PappersApi.BodaccCreationAllOf);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccCreationAllOf();
