...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccCreation();
  });
  ...
  describe('BodaccCreation', function() {
    it('should create an instance of BodaccCreation', function() {
      // uncomment below and update the code to test BodaccCreation
      //var instane = new PappersApi.BodaccCreation();
      //expect(instance).to.be.a(PappersApi.BodaccCreation);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccCreation();
