...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.EntrepriseBase();
  });
  ...
  describe('EntrepriseBase', function() {
    it('should create an instance of EntrepriseBase', function() {
      // uncomment below and update the code to test EntrepriseBase
      //var instane = new PappersApi.EntrepriseBase();
      //expect(instance).to.be.a(PappersApi.EntrepriseBase);
    });

    it('should have the property siren (base name: "siren")', function() {
      // uncomment below and update the code to test the property siren
      //var instance = new PappersApi.EntrepriseBase();
