...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccModificationAllOf();
  });
  ...
  describe('BodaccModificationAllOf', function() {
    it('should create an instance of BodaccModificationAllOf', function() {
      // uncomment below and update the code to test BodaccModificationAllOf
      //var instane = new PappersApi.BodaccModificationAllOf();
      //expect(instance).to.be.a(PappersApi.BodaccModificationAllOf);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccModificationAllOf();
