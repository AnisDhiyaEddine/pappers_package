...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PappersApi.BodaccImmatriculation();
  });
  ...
  describe('BodaccImmatriculation', function() {
    it('should create an instance of BodaccImmatriculation', function() {
      // uncomment below and update the code to test BodaccImmatriculation
      //var instane = new PappersApi.BodaccImmatriculation();
      //expect(instance).to.be.a(PappersApi.BodaccImmatriculation);
    });

    it('should have the property rcs (base name: "rcs")', function() {
      // uncomment below and update the code to test the property rcs
      //var instance = new PappersApi.BodaccImmatriculation();
